...
<!-- article end -->
    ...
    <section id="article" class="text-center p-5">
        <div class="container">
            <h1 class="navlink fw-bold display-6 pb-3 fst-italic">Top Maps</h1>
            <div class="row row-cols-1 row-cols-md-3 g-4 justify-content-center">
                <!-- Card 1 -->
                <div class="col">
                    <div class="isiCard card h-100">
                        <img src="https://www.kjcesports.com/wp-content/uploads/2023/01/Lotus_LoadingScreen_P1.jpg"
                            class="card-img-top" alt="..." />
                        <div class="card-body">
                            <h5 class="card-title">Lotus</h5>
                            <p class="card-text">
                                A mysterious structure housing an astral conduit radiates with ancient power. Great
                                stone doors provide a variety of movement opportunities and unlock the paths to three
                                mysterious sites.
                            </p>
                        </div>
                    </div>
